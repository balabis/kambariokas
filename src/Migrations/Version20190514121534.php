 ...
 */
final class Version20190514121534 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_match CHANGE user_id matched_user_id CHAR(36) NOT NULL 
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE full_name full_name VARCHAR(255) DEFAULT \'NULL\' 
            ...
            LONGTEXT NOT NULL COLLATE utf8mb4_bin, CHANGE profile_picture profile_picture VARCHAR(255) 
            DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE aboutme aboutme VARCHAR(255) 
        ...
        $this->addSql('ALTER TABLE user_match CHANGE matched_user_id user_id CHAR(36)
            NOT NULL COLLATE utf8mb4_unicode_ci COMMENT \'(DC2Type:uuid)\'');
        $this->addSql('ALTER TABLE user_match ADD CONSTRAINT FK_98993E5DA76ED395 
