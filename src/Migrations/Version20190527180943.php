...
final class Version20190527180943 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE message_metadata CHANGE message_id message_id CHAR(36) DEFAULT NULL 
            COMMENT \'(DC2Type:uuid)\', CHANGE participant_id participant_id 
        ...
        $this->addSql('ALTER TABLE user CHANGE questionnaire_score_id questionnaire_score_id CHAR(36) DEFAULT 
            NULL COMMENT \'(DC2Type:uuid)\', CHANGE full_name full_name VARCHAR(255) DEFAULT NULL, CHANGE gender 
            gender VARCHAR(255) DEFAULT NULL, CHANGE date_of_birth date_of_birth DATETIME DEFAULT NULL, 
            ...
            CHANGE city_part city_part VARCHAR(255) DEFAULT NULL, CHANGE budget budget VARCHAR(255) DEFAULT NULL, 
            CHANGE occupation occupation VARCHAR(255) DEFAULT NULL, CHANGE hobbies hobbies VARCHAR(255) DEFAULT 
            NULL, CHANGE university university VARCHAR(255) DEFAULT NULL, CHANGE last_activity_at last_activity_at 
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE invite CHANGE sender_id sender_id CHAR(36) DEFAULT 
            \'NULL\' COLLATE utf8mb4_unicode_ci COMMENT \'(DC2Type:uuid)\', CHANGE receiver_id 
            receiver_id CHAR(36) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci COMMENT \'(DC2Type:uuid)\'');
        $this->addSql('ALTER TABLE message CHANGE thread_id thread_id CHAR(36) DEFAULT \'NULL\' 
            COLLATE utf8mb4_unicode_ci COMMENT \'(DC2Type:uuid)\', CHANGE sender_id sender_id CHAR(36)
        ...
        $this->addSql('ALTER TABLE user CHANGE questionnaire_score_id questionnaire_score_id CHAR(36) 
            ...
            CHANGE city city VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE roles roles LONGTEXT
             NOT NULL COLLATE utf8mb4_bin, CHANGE profile_picture profile_picture VARCHAR(255) DEFAULT \'NULL\' 
             COLLATE utf8mb4_unicode_ci, CHANGE aboutme aboutme VARCHAR(255) DEFAULT \'NULL\' COLLATE 
             utf8mb4_unicode_ci, CHANGE city_part city_part VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, 
             CHANGE budget budget VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE occupation 
             occupation VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE hobbies hobbies VARCHAR(255) 
             DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE university university VARCHAR(255) DEFAULT \'NULL\' 
             COLLATE utf8mb4_unicode_ci, CHANGE last_activity_at last_activity_at DATETIME NOT NULL');
    }
}
