 ...
 */
final class Version20190602105943 extends AbstractMigration
{
 ...
 NUMERIC(3, 2) DEFAULT NULL, CHANGE cleanliness cleanliness NUMERIC(3, 2) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE user CHANGE questionnaire_score_id questionnaire_score_id CHAR(36) DEFAULT NULL
         ...
         VARCHAR(255) DEFAULT NULL, CHANGE last_activity_at last_activity_at DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D6498CD003DC FOREIGN KEY (questionnaire_score_id) 
REFERENCES questionnaire_score (id) ON DELETE SET NULL');
...
INT DEFAULT NULL, CHANGE notifiable_entity_id notifiable_entity_id INT DEFAULT NULL');
        ...
        occupation occupation VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE hobbies hobbies 
        VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE university university VARCHAR(255) 
        DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE last_activity_at last_activity_at DATETIME DEFAULT 
        \'NULL\'');
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D6498CD003DC FOREIGN KEY (questionnaire_score_id)
