 ...
 */
final class Version20190602121207 extends AbstractMigration
{
 ...
 NUMERIC(3, 2) DEFAULT NULL, CHANGE cleanliness cleanliness NUMERIC(3, 2) DEFAULT NULL');
        $this->addSql('ALTER TABLE user CHANGE questionnaire_score_id questionnaire_score_id CHAR(36) DEFAULT 
        NULL COMMENT \'(DC2Type:uuid)\', CHANGE full_name full_name VARCHAR(255) DEFAULT NULL, CHANGE email email 
        VARCHAR(320) NOT NULL, CHANGE gender gender VARCHAR(255) DEFAULT NULL, CHANGE date_of_birth date_of_birth 
        DATETIME DEFAULT NULL, CHANGE city city VARCHAR(255) DEFAULT NULL, CHANGE roles roles JSON NOT NULL, CHANGE 
        profile_picture profile_picture VARCHAR(255) DEFAULT NULL, CHANGE aboutme aboutme VARCHAR(255) DEFAULT NULL, 
        CHANGE city_part city_part VARCHAR(255) DEFAULT NULL, CHANGE budget budget VARCHAR(255) DEFAULT NULL, CHANGE 
        occupation occupation VARCHAR(255) DEFAULT NULL, CHANGE hobbies hobbies VARCHAR(255) DEFAULT NULL, CHANGE 
        university university VARCHAR(255) DEFAULT NULL, CHANGE last_activity_at last_activity_at DATETIME DEFAULT 
        NULL');
        ...
        $this->addSql('ALTER TABLE notifiable_notification CHANGE notification_id notification_id 
INT DEFAULT NULL, CHANGE notifiable_entity_id notifiable_entity_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE notification CHANGE message message VARCHAR(4000) DEFAULT NULL, 
CHANGE link link VARCHAR(4000) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        utf8mb4_unicode_ci COMMENT \'(DC2Type:uuid)\', CHANGE receiver_id receiver_id CHAR(36) DEFAULT 
...
INT DEFAULT NULL, CHANGE notifiable_entity_id notifiable_entity_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE notification CHANGE message message VARCHAR(4000) DEFAULT \'NULL\'
         COLLATE utf8mb4_unicode_ci, CHANGE link link VARCHAR(4000) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
        ...
        $this->addSql('ALTER TABLE thread_metadata CHANGE thread_id thread_id CHAR(36) DEFAULT \'NULL\'
         COLLATE utf8mb4_unicode_ci COMMENT \'(DC2Type:uuid)\', CHANGE participant_id participant_id CHAR(36)
          DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci COMMENT \'(DC2Type:uuid)\', CHANGE 
          last_participant_message_date last_participant_message_date DATETIME DEFAULT \'NULL\', CHANGE 
          last_message_date last_message_date DATETIME DEFAULT \'NULL\'');
        ...
        VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE email email VARCHAR(180) NOT NULL 
        ...
        CHANGE date_of_birth date_of_birth DATETIME DEFAULT \'NULL\', CHANGE city city VARCHAR(255) DEFAULT \'NULL\'
         COLLATE utf8mb4_unicode_ci, CHANGE roles roles LONGTEXT NOT NULL COLLATE utf8mb4_bin, CHANGE 
         profile_picture profile_picture VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE 
         aboutme aboutme VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE city_part city_part 
         VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE budget budget VARCHAR(255) DEFAULT 
         \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE occupation occupation VARCHAR(255) DEFAULT \'NULL\' 
         COLLATE utf8mb4_unicode_ci, CHANGE hobbies hobbies VARCHAR(255) DEFAULT \'NULL\' COLLATE 
         utf8mb4_unicode_ci, CHANGE university university VARCHAR(255) DEFAULT \'NULL\' COLLATE 
         utf8mb4_unicode_ci, CHANGE last_activity_at last_activity_at DATETIME DEFAULT \'NULL\'');
    }
}
