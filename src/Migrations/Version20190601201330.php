 ...
 */
final class Version20190601201330 extends AbstractMigration
{
 ...
 NUMERIC(3, 2) DEFAULT NULL, CHANGE cleanliness cleanliness NUMERIC(3, 2) DEFAULT NULL');
        $this->addSql('ALTER TABLE user ADD is_active TINYINT(1) NOT NULL, DROP status, CHANGE questionnaire_score_id
     questionnaire_score_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', CHANGE full_name full_name 
     VARCHAR(255) 
     DEFAULT NULL, CHANGE gender gender VARCHAR(255) DEFAULT NULL, CHANGE date_of_birth date_of_birth DATETIME DEFAULT 
         NULL, CHANGE city city VARCHAR(255) DEFAULT NULL, CHANGE roles roles JSON NOT NULL, CHANGE profile_picture 
         profile_picture VARCHAR(255) DEFAULT NULL, CHANGE aboutme aboutme VARCHAR(255) DEFAULT NULL, CHANGE city_part 
         city_part VARCHAR(255) DEFAULT NULL, CHANGE budget budget VARCHAR(255) DEFAULT NULL, CHANGE 
         occupation occupation VARCHAR(255) DEFAULT NULL, CHANGE hobbies hobbies VARCHAR(255) DEFAULT NULL, 
         CHANGE university university VARCHAR(255) DEFAULT NULL, CHANGE last_activity_at last_activity_at 
...
INT DEFAULT NULL, CHANGE notifiable_entity_id notifiable_entity_id INT DEFAULT NULL');
 ...
 CHANGE link link VARCHAR(4000) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        utf8mb4_unicode_ci 
COMMENT \'(DC2Type:uuid)\', CHANGE receiver_id receiver_id CHAR(36) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci COMMENT
         \'(DC2Type:uuid)\'');
        $this->addSql('ALTER TABLE message CHANGE thread_id thread_id CHAR(36) DEFAULT \'NULL\' COLLATE 
        utf8mb4_unicode_ci
 COMMENT \'(DC2Type:uuid)\', CHANGE sender_id sender_id CHAR(36) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci COMMENT 
         \'(DC2Type:uuid)\'');
...
CHANGE notifiable_entity_id notifiable_entity_id INT DEFAULT NULL');
        ...
        DROP is_active, CHANGE questionnaire_score_id questionnaire_score_id CHAR(36) DEFAULT \'NULL\' 
        ...
        utf8mb4_unicode_ci, CHANGE city_part city_part VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci,
         CHANGE budget budget VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE occupation occupation
          VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE hobbies hobbies VARCHAR(255) DEFAULT 
          \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE university university VARCHAR(255) DEFAULT \'NULL\' COLLATE 
